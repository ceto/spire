...
function spire_custom_taxonomies() {
  ...
  register_taxonomy( 'project_category', array( 'project' ), $args );
    ...
    //Project Tags
  $labels = array(
    'name'                       => _x( 'Project Tags', 'Project Tag General Name', 'text_domain' ),
    'singular_name'              => _x( 'Project Tag', 'Project Tag Singular Name', 'text_domain' ),
    'menu_name'                  => __( 'Project Tag', 'text_domain' ),
    'all_items'                  => __( 'All Items', 'text_domain' ),
